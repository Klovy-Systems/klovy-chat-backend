// auth_fallback.rs
// Gdy Turnstile bypass: honeypot, timing, twardszy IP.
// Zakres:
//  - Verified Turnstile = prawie passthrough
//  - gdy Turnstile bypass: honeypot, timing, twardszy IP
// Nie wyłączaj tego w prod gdy siteverify pada.
// Przy zmianach: captcha.rs, security/bots.rs, timing.rs.
