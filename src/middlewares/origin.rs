// origin.rs
// Sprawdza Origin względem FRONTEND_URL / localhost.
// Zakres:
//  - mutacje i WS
//  - Origin vs FRONTEND_URL / localhost; mutacje i WS
// Nowy origin deployu: ENV, nie hardcoded (poza DEV).
// Przy zmianach: utils/security/origin.rs, ws/mod.rs.
