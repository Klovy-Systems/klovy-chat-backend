// username.rs
// Normalizacja i legalne znaki username.
// Zakres:
//  - unikalność w modelu
//  - normalizacja i znaki — FE jest UX, to jest prawo
// FE username.ts jest UX — to jest prawo.
// Przy zmianach: auth/validation.rs.
