// urls.rs
// Allowlista URL (CDN, Giphy, LiveKit, emoji JSON).
// Zakres:
//  - embed i proxy
//  - CDN, Giphy, LiveKit, emoji JSON — nowy host też na FE
// Nowy host mediów: tu + FE allowedMedia.ts.
// Przy zmianach: gifs.rs, livekit, ExternalMedia.
