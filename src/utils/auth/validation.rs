// validation.rs
// Reguły email/password/username na serwerze.
// Zakres:
//  - źródło prawdy vs FE UX
//  - email/password/username — źródło prawdy vs FE UX
// Zmiana bez FE = zły komunikat, ale bezpieczniej niż odwrotnie.
// Przy zmianach: password.ts, username.ts.
