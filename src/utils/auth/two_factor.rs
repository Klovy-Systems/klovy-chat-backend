// two_factor.rs
// Enable/disable TOTP, backup kody.
// Zakres:
//  - sekret tylko przy setupie
//  - enable/disable, backup; sekret tylko przy setupie
// Disable wymaga step-up hasła.
// Przy zmianach: totp.rs, step_up.rs.

use jsonwebtoken::{decode, encode, DecodingKey, EncodingKey};
use serde::{Deserialize, Serialize};
use std::env;

use crate::utils::auth::validation::{hs256_header, hs256_validation, JWT_AUDIENCE, JWT_ISSUER};
