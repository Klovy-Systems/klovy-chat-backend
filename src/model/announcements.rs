// announcements.rs
// Ogłoszenie serwera (treść, okno czasowe).
// Zakres:
//  - lista dla klienta
//  - treść + okno czasowe; nie mylić z warnings
// Nie mieszaj z warnings (to nie jest kara na konto).
// Przy zmianach: controllers/announcements.rs.
