// audit.rs
// Wpis audytu (aktor, akcja, cel).
// Zakres:
//  - ślady wrażliwych operacji
//  - aktor, akcja, cel — pisz po udanej mutacji
// Pisz po udanej mutacji, nie przed (inaczej fałszywy ślad).
// Przy zmianach: utils/admin/mod.rs.
