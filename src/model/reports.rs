// reports.rs
// Zgłoszenie treści/kanału.
// Zakres:
//  - reporter, powód, target
//  - zgłoszenie treści/kanału; reporter nie wychodzi publicznym API
// Nie zwracaj reportera innym userom w publicznym API.
