// encrypt.rs
// Szyfrowanie payloadu ramki kluczem sesji.
// Zakres:
//  - prod wymaga tokenu z handshake
//  - payload ramki kluczem sesji; prod bez tokenu = nie plaintext
// Zmiana algorytmu = FE socketCrypto.ts w tym samym releasie.
// Przy zmianach: ws/keys.rs, api/ws.ts.
