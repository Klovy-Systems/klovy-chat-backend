// keys.rs
// Wydawanie i lookup tokenu /ws-crypto.
// Zakres:
//  - per sesja
//  - wydanie i lookup /ws-crypto per sesja; klucz nie w logach
// Nie zwracaj klucza w logach.
// Przy zmianach: ws/encrypt.rs, ws/mod.rs handshake.
