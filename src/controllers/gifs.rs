// gifs.rs
// Proxy wyszukiwania Giphy GIF.
// Zakres:
//  - allowlista URL w odpowiedzi
//  - proxy Giphy; allowlista URL w odpowiedzi
// Quota i klucz tylko w ENV serwera.
// Przy zmianach: api/gifs.ts, controllers/stickers.rs.
