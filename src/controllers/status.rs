// status.rs
// Healthcheck pod load balancer / wait-on.
// Zakres:
//  - tani GET
//  - tani GET pod LB / wait-on; bez Mongo
// Nie rób tu zapytań Mongo — liveness ma być tani.
// Przy zmianach: loaders/server.rs, waitBackend.ts.
